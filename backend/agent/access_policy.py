...
SKILL_CLASSES = {
    ...
    "general.follow_player": "task.movement",
    ...
    "world.inspect_block": "observe.basic",
    "world.scan_crops": "observe.basic",
    "world.harvest_crop_at": "task.resource",
    "world.break_block_at": "task.resource",
    "world.use_block_at": "task.resource",
    "world.place_block_at": "task.resource",
    "core.eat": "task.inventory",
    "general.eat": "task.inventory",
    "core.use_item": "task.inventory",
    "core.server_command": "task.server_command",
...
DEFAULT_ROLE_SKILLS: dict[str, dict[str, str]] = {
    ...
    "owner": {"chat.reply": "allow", "observe.basic": "allow", "task.movement": "allow", "task.resource": "allow", "task.inventory": "allow", "task.combat": "allow", "task.server_command": "allow"},
    "server_moderator": {"chat.reply": "allow", "observe.basic": "allow", "task.moderation": "allow", "safety.stop": "allow"},
    "operator": {"chat.reply": "allow", "observe.basic": "allow", "safety.stop": "allow", "task.movement": "allow", "task.resource": "allow", "task.inventory": "allow", "task.combat": "allow", "task.world": "allow", "task.server_command": "allow", "admin.body": "allow"},
    "server_admin": {"*": "allow"},
